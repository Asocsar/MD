#Row selection
```{r}
setwd("C:/Users/danie/Desktop/MD/MD/D2") #set the working directory
...
```{r}
write.csv(df_clean, "clean_table.csv", row.names = FALSE)
write.csv(df_clean[var_numericas], "clean_table_numericas.csv", row.names = FALSE)
```
